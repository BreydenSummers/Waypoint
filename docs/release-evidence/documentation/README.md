...
| TLS and secrets | [TLS and secret handling](../../operator-guide.md#tls-and-secret-handling) | [`scripts/waypoint-installer.sh`](../../../scripts/waypoint-installer.sh), [`cmd/waypoint/main.go`](../../../cmd/waypoint/main.go) | Loopback default, TLS startup, and restrictive file modes are explicit. |
